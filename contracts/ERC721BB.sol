 ...
 *
 * Pseudo random assignment of minted token id.
 */
contract ERC721BB is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function approve(address to, uint256 tokenId) public override {
        address owner = ERC721BB.ownerOf(tokenId);
